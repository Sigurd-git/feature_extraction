...
input_directory = '/home/gliao2/snormanh_lab_shared/projects/intracranial-natsound165/stimuli/stimulus_audio';
project_directory = '/home/gliao2/snormanh_lab_shared/projects/intracranial-natsound165';
fnames = mydir(input_directory, '.wav');

% fnames = {'bigbang_audio', 'seinfeld_audio'};

% compute features and get PCs from frames
framed_feature_directory = [project_directory '/analysis/acoustics/real'];
