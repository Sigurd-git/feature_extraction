...
P.temp_mod_rates = [1,2,4,8,16,32,64,128];
P.temp_mod_lowpass = [zeros(1,8)];
...
P.spec_mod_rates = [0.25,0.5,1,2,4,8];
P.spec_mod_lowpass = [zeros(1,6)];

% % Just spectral
% P.temp_mod_rates = NaN;
% P.temp_mod_lowpass = 0;
% % Just temporal
% P.spec_mod_rates = NaN;
% P.spec_mod_lowpass = 0;
