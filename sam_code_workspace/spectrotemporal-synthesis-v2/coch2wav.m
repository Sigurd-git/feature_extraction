...
assert(size(coch_envs_audio_sr_erbf_reconstructed,2)==size(R.recon_error_audio_sr_erbf,2));
if size(coch_envs_audio_sr_erbf_reconstructed,1)>size(R.recon_error_audio_sr_erbf,1)
    coch_envs_audio_sr_erbf_reconstructed = ...
        coch_envs_audio_sr_erbf_reconstructed(1:size(R.recon_error_audio_sr_erbf,1), :);
end
assert(size(coch_envs_audio_sr_erbf_reconstructed,1)==size(R.recon_error_audio_sr_erbf,1));
