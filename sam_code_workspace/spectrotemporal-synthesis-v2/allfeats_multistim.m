function [coch_output_directory, ...
    modulation_output_directory] = allfeats_multistim(...
    modulation_types, stimuli, sr, input_directory, output_directory, P_orig)
...
for i = 1:length(stimuli)
    ...
    P_MAT_file = [coch_output_directory '/P_' fname '.mat'];
